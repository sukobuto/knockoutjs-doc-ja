...
$menues = array(
	...
	'<h2>;4' => 'カスタムバインディングの作成',
	'custom-bindings' => 'カスタムバインディングを作成',
	'custom-bindings-controlling-descendant-bindings' => '配下のバインディングを制御する',
	'custom-bindings-for-virtual-elements' => '仮想エレメントにバインド<br>できるようにする',
	'custom-bindings-disposal' => '破棄処理をカスタマイズ',
